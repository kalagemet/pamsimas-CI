...
@section('title', 'Riwayat Admin | Sistem Informasi Pamsimas')
@section('content')
<!-- BEGIN:isi -->
...
<script type="text/javascript">
    // $(document).ready(function(){
        tampil_pelanggan(`{{url('/admin/get_riwayat_admin?page=')}}`);   //pemanggilan fungsi tampil barang.
        ...
        function tampil_pelanggan(page){
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    var no_page = '';
                    var nex = '';
                    var url = "{{url('/admin/get_riwayat_admin?page=')}}";
