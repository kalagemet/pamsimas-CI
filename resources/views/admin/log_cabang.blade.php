...
@section('title', 'Riwayat Cabang | Sistem Informasi Pamsimas')
@section('content')
<!-- BEGIN:isi -->
...
<script type="text/javascript">
    // $(document).ready(function(){
        tampil_pelanggan(`{{url('/admin/get_riwayat_cabang?page=')}}`);   //pemanggilan fungsi tampil barang.
        ...
        function tampil_pelanggan(page){
            ...
            $.ajax({
                ...
                success : function(data){
                        ...
                        for(i=0; i<data.data.length; i++){
                            html += '<tr data-row="0" class="m-datatable__row" style="left: 0px;">'+
                                        ...
                                        '<td data-field="Field #3" class="m-datatable__cell">'+
                                            '<span style="width: 100px;">'+data.data[i].cabang+' ('+data.data[i].id_cab+')</span>'+
                                        '</td>'+
                                    '</tr>';
                        }
                    }
                    ...
                    var no_page = '';
                    var nex = '';
                    var url = "{{url('/admin/get_riwayat_cabang?page=')}}";
