...
@section('title', 'Riwayat Sistem | Sistem Informasi Pamsimas')
@section('content')
<!-- BEGIN:isi -->
...
<script type="text/javascript">
    // $(document).ready(function(){
        tampil_pelanggan(`{{url('/cabang/get_riwayat_sistem?page=')}}`);   //pemanggilan fungsi tampil barang.
        ...
        function tampil_pelanggan(page){
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    var no_page = '';
                    var nex = '';
                    var url = "{{url('/cabang/get_riwayat_sistem?page=')}}";
